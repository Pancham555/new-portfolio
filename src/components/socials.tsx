        ...
        <a href="https://x.com/pancham_barman" target="_blank" aria-label="X">
          <Card className="px-5 py-10 bg-black relative">
            ...
            <svg
              ...
              id="Layer_1"
              viewBox="0 0 24 24"
              className="m-auto fill-white w-16"
            >
        ...
        <div className="grid grid-cols-3 gap-2 pt-2">
          ...
          >
            <Card className=" bg-black p-2 py-3 relative">
              ...
              />
              <svg
                className="fill-white m-auto w-[80%]"
          ...
          <Card className="flex justify-center items-center border-dashed">
            <Upload className="m-auto text-muted-foreground" size={30} />
          </Card>
        </div>
      </CardContent>
    </Card>
